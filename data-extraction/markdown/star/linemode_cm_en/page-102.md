...
| [Name]   | Raster mode NV audio playback   | Raster mode NV audio playback   | Raster mode NV audio playback   | Raster mode NV audio playback   | Raster mode NV audio playback   |
|----------|---------------------------------|---------------------------------|---------------------------------|---------------------------------|---------------------------------|
| [Code]   | ASCII                           | ESC                             | *                               | r                               | S                               |
