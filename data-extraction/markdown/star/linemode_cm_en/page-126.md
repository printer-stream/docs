...
Also, if the value of n is out of the defined range, subsequent data are processed as normal data. This command is affected by position alignment, left margin, moved position, positions such as
