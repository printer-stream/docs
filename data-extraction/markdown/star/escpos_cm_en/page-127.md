...
Start/execute macro definition
...
- If this command is input during normal operation, the macro definition is started.
...
- Operators should be aware that if the raster graphic command (GS v) is inserted into the data while defining a macro, the macro definition is immediately ended as being undefined and the printer enters a raster graphics process.
