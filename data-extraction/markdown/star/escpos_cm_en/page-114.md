...
Sends the size information of the symbol data stored in the symbol saving region by GS ( k Function 080.
...
* 1 The horizontal and vertical sizes are shown as the number symbol dots. The decimal value of the horizontal and vertical sizes are converted to character data and sent in order from the MSB. Ex.: When the horizontal size is 120 dots, '120' is converted to 3 bytes of data (Hex:31H, 32H, 30H, Decimal:49, 50, 48).

* 2 'Other information' indicates whether it is possible to print symbol data stored in the sav -ing region.
