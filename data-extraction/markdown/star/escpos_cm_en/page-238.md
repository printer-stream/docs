...
- Reduced printing of barcodes can be enabled or disabled by memory switch setting. However, cares must be taken as the print position other than the barcode is affected if reduced printing is disabled.
