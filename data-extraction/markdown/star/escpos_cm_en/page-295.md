...
- &lt;Example 2: Sample Program using Basic&gt; 100 PRINT #1, CHR$(&amp;H1B); 'L'; 110 PRINT #1, CHR$(&amp;H1B); 'W'; CHR$(0); CHR$(0); CHR$(0); CHR$(0); 120 PRINT #1, CHR$(200); CHR$(0); CHR$(144); CHR$(1); 130 PRINT #1, CHR$(&amp;H1B); 'T'; CHR$(0); 140 PRINT #1, 'Page mode lesson 2 CAN command' 150 PRINT #1, CHR$(&amp;HA); 160 PRINT #1, 'ABCDEFGHIJKLMNOPQRST1234567890'
- 170 PRINT #1, CHR$(&amp;HC);
