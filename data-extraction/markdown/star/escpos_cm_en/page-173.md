...
In ESC * m n L n H [d]k, d1  =  &lt;10&gt;H, d2  =  &lt;05&gt;H, d3  =  &lt;01&gt;H

- Do not use this command to interrupt code strings of other commands that consist of 2 or more codes.

Ex.:

If you attempt to transmit DLE EBQ 2 up to transmitting ESC3 by trying to transmit ESC 3 n from the host, it is processed as ESC 3 10H. Operators must use caution.
