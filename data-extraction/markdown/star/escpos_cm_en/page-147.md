...
After expanding the current serial counter value as print data (a character string) to the print buffer, the printer counts up or counts down according to the count mode.

Details

- The counter value expanded to the print buffer the printer prints by either the print instruction or by a print buffer full.
