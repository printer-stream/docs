...
When printing a bar code with the current settings and at the print starting position using this command, error information is sent from the printer.  Therefore, it is possible to check whether it is possible to print before actually printing, by using this command.
