...
| ESCGS#m    | Spec. B      | x            | Spec. B      | x            | Spec. B      | Spec. B                                             | x            | x            | x            | x            | x            | x            | x            | x            |
| ESCRSF     | x            | x            | x            | x            | ○            | ○                                                   | x            | x            | x            | x            | x            | x            | x            | x            |
| ESCRSC     | x            | x            | x            | x            | x            | ○                                                   | x            | x            | x            | x            | x            | x            | x            | x            |
| ESCRSL     | x            | x            | x            | x            | x            | Ver. 1.3~ 1.4 Spec. B Ver. 2.0 or later             | x            | x            | x            | x            | x            | x            | x            | x            |
| ESCGSETX   | x            | x            | x            | x            | x            | Spec. A Ver. 2.0 or later Spec. B Ver. 3.0 or later | x            | x            | x            | x            | x            | x            | x            | x            |
