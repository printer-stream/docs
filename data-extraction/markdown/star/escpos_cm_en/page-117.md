...
Prints QR Code symbol data stored in the symbol saving region
...
Executes encoding and printing the symbol data stored in the symbol saving region, by GS ( k Function 181 command.

Note

The user must ensure the quiet zone.

## &lt;Function	182&gt;	GS	(	k	pL	pH	cn	fn	m	(cn=49,	fn=82)

Name

Send size information of the symbol data of the QR Code symbol saving region
