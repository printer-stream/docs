...
Compound symbol: Set module siz
...
The width of one module for compound symbols is set to n dots.

Note

The setting for this function affects the processing of function 481.
...
The maximum width of the GS1DataBar Expanded Stacked in compound symbols is set to n dots.
