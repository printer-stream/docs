...
Selects the standard PDF417 options.

Selects the simple PDF417 options.
...
2 ≤ d ≤ 255, k = (pL + pH×256) - 3

Function

Stores the symbol data (d1 … dk) of PDF417 in the symbol saving region.

Details

Data stored in the symbol saving region using this function is processed using Function 081 and 082.
