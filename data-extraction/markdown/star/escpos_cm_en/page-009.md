...
Start-Stop synchronization method DTR/DSR/XON/XOFF
...
Handshake, bit length, baud rates and parity settings are set by the DIP switches or the memory switches.
...
(When the roll paper end sensor detects that paper is out, or the roll paper near end sensor de tects that paper is out using ESCc4, or paper is out when the print stop is enabled.)
