...
|   m | Mode                  |   Number of Vert. Dir. Dots | Number of Hor. Dir. Dots   | Density of Hor. Dir. Dots   | Data Count (k)   |
|-----|-----------------------|-----------------------------|----------------------------|-----------------------------|------------------|
...
- If the value of m is out of the specified range, n L and subsequent data are processed as normal data.
- n L and n H indicate the number of dots in the bit image in the horizontal direction to print. The number of dots is calculated by (n L + nH x256).
...
|   m | Mode                  | Density of Vert. Direction Dots   | Density of Hor. Direction Dots   |
|-----|-----------------------|-----------------------------------|----------------------------------|
