...
Sets PDF417 symbol position count (level length).

- When n = 0, sets the automatic process.

- When n≠0, sets the number of positions of the symbol data region to n code words.
...
The number of positions when automatic processing is specified (n = 0), calculates the number of code words based on the current print region, when processing Functions 081, and 082, module width (Function 067), and the option settings (Function 070).

This setting is valid until ESC @ is executed, the printer is reset or the power is turned off.

Reference

GS ( k Function 081, 082, 067, 070, ESC @
