...
```
[Name] Transmit the data in the specified record [Format] ASCII GS ( C pL pH m fn b c1 c2 Hex 1D 28 43 05 00 00 fn 00 c1 c2 Decimal 29 40 67 5 0 0 fn 0 c1 c2 [Range] ( pL + pH × 256) = 5 ( pL = 5, pH = 0) m = 0 fn = 2, 50 b = 0 32 ≤ c1 ≤ 126 32 ≤ c2 ≤ 126
```
