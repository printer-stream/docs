...
```
ASCII GS ( k pL pH cn fn m Hex 1D 28 6B 03 00 34 51 30 Decimal 29 40 107 3 0 52 81 48
```
...
Encodes and prints the GS1 DataBar symbol data in the symbol storage area using the process of &lt;Function 480&gt;.
