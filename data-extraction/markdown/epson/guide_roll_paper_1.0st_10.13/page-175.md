...
```
PRINT #1, "0123456789012345678901234567890123456"; PRINT #1, CHR$(&HA); FOR i=1 TO 4 PRINT #1, CHR$(&H9); "H"; ← Execute HT NEXT i : PRINT #1, CHR$(&HA); PRINT #1, CHR$(&H1B);"D";CHR$(10);CHR$(20); PRINT #1, CHR$(30);CHR$(0); ← Set HT positions FOR i=1 TO 4 PRINT #1, CHR$(&H9); "H"; ← Execute HT NEXT i : PRINT #1, CHR$(&HA);
```
