...
This printer is equipped with a print head configured in column format, which makes it faster to define data using Function 68 (column format) than with this function.
...
For specifying paper (2-color/single-color), see Functions5 of GS ( E .
