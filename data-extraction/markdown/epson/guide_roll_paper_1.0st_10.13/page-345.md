...
It is recommended to use GS r 1 to check the status and GS r for transmitting the paper sensor status.
...
| 0, 1  | 11       | 03    | 3         | Roll paper near-end sensor: paper near end. |
