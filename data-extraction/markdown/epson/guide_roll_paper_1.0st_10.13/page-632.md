...
```
[Name] MaxiCode: Print the symbol data in the symbol storage area [Format] ASCII GS ( k pL pH cn fn m Hex 1D 28 6B 03 00 32 51 m Decimal 29 40 107 3 0 50 81 m [Range] ( pL + pH × 256) = 3 ( pL = 3, pH = 0 ) cn = 50 fn = 81 m = 48
```

[Description] [Notes]

Encodes and prints the MaxiCode symbol data in the symbol storage area using the process of &lt;Function 280&gt;.
