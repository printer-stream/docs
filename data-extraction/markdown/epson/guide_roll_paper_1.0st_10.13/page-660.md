...
| (                    | 28                   | 40                   | Each character is inserted for the HRI character. It makes the HRI characters look nice when used to enclose the AI. The data does not constitute encoded data. |
| )                    | 29                   | 41                   | Each character is inserted for the HRI character. It makes the HRI characters look nice when used to enclose the AI. The data does not constitute encoded data. |
