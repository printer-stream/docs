...
```
[Name] [Format] ASCII ESC E n Hex 1B 45 n Decimal 27 69 n [Range] 0 ≤ n ≤ 255 [Default] n = 0
```
...
```
PRINT #1, CHR$(&H1B);"E";CHR$(1); ← Select PRINT #1, "AAAAA"; CHR$(&HA); PRINT #1, CHR$(&H1B);"E";CHR$(0); ← Cancel PRINT #1, "BBBBB"; CHR$(&HA);
```
