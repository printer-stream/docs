...
$$ASCII FS ( L pL pH fn m Hex 1C 28 4C 02 00 42 m Decimal 28 40 76 2 0 66 m$$

[Range]

$$( pL + pH × 256) = 2 ( pL = 2, pH = 0) m = 48, 49 fn = 66$$
...
|   m | Function                                                                                                                                                |
|-----|---------------------------------------------------------------------------------------------------------------------------------------------------------|
|  48 | Feeds paper to the cutting position. However, if the paper is in standby at the cutting position, the printer does not feed.                            |
|  49 | Feeds paper to the cutting position. However, if the paper is in standby at the cutting position, the printer feeds paper to the next cutting position. |
