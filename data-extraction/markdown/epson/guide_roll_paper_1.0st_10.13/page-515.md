...
|-------|----------|-------|-----------|-----------------------------------------------|
|     0 | Off      | 00    | 0         | Multi-byte character codes are not supported. |
|     0 | On       | 01    | 1         | Multi-byte character codes are supported.     |
|     1 | Off      | 00    | 0         | Autocutter not installed.                     |
|     1 | On       | 02    | 2         | Autocutter installed.                         |
|     2 | Off      | 00    | 0         | DM-D (customer display) is not installed.     |
|     2 | On       | 04    | 4         | DM-D (customer display) is installed.         |
|     3 | --       | --    | --        | Reserved.                                     |
