...
```
[Name] Select count mode (A) [Format] ASCII GS C 1 aL aH bL bH n r Hex 1D 43 31 aL aH bL bH n r Decimal 29 67 49 aL aH bL bH n r [Range] 0 ≤ ( aL + aH × 256) ≤ 65535 (0 ≤ aL ≤ 255, 0 ≤ aH ≤ 255) 0 ≤ ( bL + bH × 256) ≤ 65535 (0 ≤ bL ≤ 255, 0 ≤ bH ≤ 255) 0 ≤ n ≤ 255, 0 ≤ r ≤ 255 [Default] ( aL + aH × 256) = 1 ( aL = 1, aH = 0) ( bL + bH × 256) = 65535 ( bL = 255, bH = 255) n = 1, r = 1
```
...
| Count-up   | aL + aH × 256 < bL + bH × 256 and n ≠ 0 and r ≠ 0 | aL + aH × 256   | bL + bH × 256   |
| Count-down | aL + aH × 256 > bL + bH × 256 and n ≠ 0 and r ≠ 0 | bL + bH × 256   | aL + aH × 256   |
| Count-stop | aL + aH × 256 = bL + bH × 256 or n = 0 or r = 0   | ⎯               | ⎯               |
