...
- ■ After printing a raster bit image, the printer processes normal data. The print position is set to the left of the print area. Printer is in the beginning of a line and data is not in the print buffer.
