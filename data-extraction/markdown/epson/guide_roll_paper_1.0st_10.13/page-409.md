...
```
[Name] [Format] ASCII ESC U n Hex 1B 55 n Decimal 27 85 n [Range] 0 ≤ n ≤ 255 [Default] n = 0
```
...
[Description] Turns unidirectional print mode on or off.
...
```
Program Example for all printers ← Unidirectional print mode turned on
```
