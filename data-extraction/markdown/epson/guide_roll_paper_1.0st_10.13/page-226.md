...
- Graphics [Functions 50, 112, and 113] Stores data in the print buffer. When standard mode is selected, prints data using Function 50 and clears the print buffer. When page mode is selected, prints data using FF and ESC FF and clears the print buffer after FF executed.
