...
- ■ Buzzer function: Sound pattern (Autocut) (when a = 121) (optional external buzzer)
...
Buzzer function: Sound pattern (Pulse 1) (when a = 123) (optional external buzzer)

Buzzer function: Sound pattern (Pulse 2) (when a = 125) (optional external buzzer)
