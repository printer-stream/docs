...
```
[Name] PDF417: Select the options [Format] ASCII GS ( k pL pH cn fn n Hex 1D 28 6B 03 00 30 46 n Decimal 29 40 107 3 0 48 70 n [Range] ( pL + pH × 256) = 3 ( pL =3, pH =0) cn = 48 fn = 70 m = 0,1 [Default] m = 0 [Description] Selects the option for PDF417.
```
