...
- ·
- Type ID ( n = 2, 50) Bit 1: [Autocutter is installed/not installed] indicates the state of Memory switch 2-2. Bit 2: The bit [DM-D (Customer display) isn't supported.
- Version ID ( n = 3,51) By the firmware version [When Japanese model is used or memory switch [Msw 8-7] is OFF.] Hex = 46H / Decimal = 70 [When memory switch [Msw 8-7] is ON.]
- Printer model ( n = 67)
