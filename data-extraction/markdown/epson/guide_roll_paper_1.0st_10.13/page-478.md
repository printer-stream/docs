...
- ■ When the transmitting of a process ID response occurs while some untransmitted process ID is being stored, the printer transmits the latest process ID only. Example:
...
- ■ See program example and print sample for ESC i and ESC m for description of the response transmission process.
