...
## [Explanation for memory switch 2] ( a = 2):]

- Changes the number of characters that can be printed depending on the [Msw2-3] setting. Character code system is specified by [Msw2-3] (the third bit) as shown in the following table.:

| Character code system   |   Number of characters |
|-------------------------|------------------------|
| GB2312                  |                  7,580 |
| GB18030                 |                 28,553 |
