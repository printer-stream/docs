...
When DIP switch or memory switch (BUSY condition) is Off: n = 0 When DIP switch or memory switch (BUSY condition) is On: n = 1
...
| 0        | Enable online/offline status of the ink mechanism  |        1 |            01 |         1 |
| 1        | Disable ink status detection                       |        0 |            00 |         0 |
| 1        | Enable ink status detection                        |        1 |            02 |         2 |
| 2~7      | Reserved                                           |        0 |            00 |         0 |
