...
## GS ( L pL pH m fn d1 d2 d3 &lt; Function 81&gt;

```
[Name] Delete all download graphics data. [Format] ASCII GS ( L pL pH m fn d1 d2 d3 Hex 1D 28 4C 05 00 30 51 43 4C 52 Decimal 29 40 76 5 0 48 81 67 76 82 [Range] ( pL + pH × 256) = 5 ( pL = 5, pH = 0) m = 48 fn = 65 d1 = 67 d2 = 76 d3 = 82
```
...
Deletes all downloaded graphics data that has been defined using Functions 83 and 84.
