...
The dot density and maximum print area are the same as Function 69. See the model information
...
Check that there is space in the receive buffer of the printer before transmitting this function

when transmitting the first graphic data. (You can check that the receive buffer is empty by

executing status receiving of GS r (
...
-&gt; Status receiving -&gt; This function (color 1) -&gt; This command &lt;Function 50&gt; -&gt; This function

(color 1) -&gt; This command &lt;Function 50&gt;
...
Specify the scaling to the original size (
...
Example: Specifying (Color 1 -&gt; Color 1 -&gt; Print) causes a drop in performance.
