...
```
ASCII GS ( k pL pH cn fn m Hex 1D 28 6B 03 00 33 51 30
```

```
Decimal 29 40 107 3 0 51 81 48 ( pL + pH × 256) = 3 ( pL = 3, pH = 0 ) cn = 51 fn = 81 m = 48
```

Encodes and prints the GS1 DataBar symbol data in the symbol storage area using the process of &lt;Function 380&gt;.
