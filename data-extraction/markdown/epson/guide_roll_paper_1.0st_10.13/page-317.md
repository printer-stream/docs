...
|---------|-------------|--------------------------|--------------------------|--------------------------|--------------|--------------------------|
|         | Dot density | Maximum print area (dot) | Maximum print area (dot) | Maximum print area (dot) |              |                          |
| Scaling |             | Paper width 80mm         | Paper width 60mm         | Paper width 58mm         | Dot density  | Maximum print area (dot) |
...
|---------|-------------|--------------------------|--------------------------|--------------|--------------------------|
| Scaling | Dot density | Maximum print area (dot) | Maximum print area (dot) |              |                          |
|         |             | Paper width 80mm         | Paper width 60 / 58mm    | Dot density  | Maximum print area (dot) |
