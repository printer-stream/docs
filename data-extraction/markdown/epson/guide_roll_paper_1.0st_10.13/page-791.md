...
```
[Name] Save the setting values from the work area into the storage area [Format] ASCII GS ( M pL pH  fn  m Hex 1D 28 4D 02 00 fn m Decimal 29 40 77 2 0 fn m [Range] ( pL + pH × 256 ) = 2 , ( pL = 2 , pH = 0 ), fn = 1, 49 TM-J2000/J2100 , TM-T90 , TM-L90 , TM-P60 : m = 1, 49
```

[Description]

Saves the setting values of commands listed in the tables on the previous pages and stored in the work area in the storage area specified by m .
