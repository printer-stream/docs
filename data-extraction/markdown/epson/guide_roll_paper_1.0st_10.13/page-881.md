...
For example, here is how you would use the table on the next page, which selects the print mode, to combine double-height, double-width, and underline. In the table, you see that bit 4 on (or hex 10 or decimal 16) turns on double-height, bit 5 on (or hex 20 or decimal 32) turns on double-width, and bit 7 on (or hex 80 or decimal 128) turns on underline mode.
