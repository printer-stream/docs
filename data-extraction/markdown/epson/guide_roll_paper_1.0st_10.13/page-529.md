...
|-------|---------------------|----------|-------|-----------|
| 0     | Paper width 80mm    | 0        | 00    | 0         |
| 0     | Paper width 58mm    | 1        | 01    | 1         |
| 1     | Resolution : 180dpi | 0        | 00    | 0         |
| 1     | Resolution : 203dpi | 1        | 02    | 2         |
| 2 ~ 5 | Reserved            | -        | -     | -         |
| 6     | Fixed               | 1        | 40    | 64        |
| 7     | Fixed               | 0        | 00    | 0         |
...
Type information (when n = 33 is specified)

The type information of this printer consists of the first to third 3 bytes.
