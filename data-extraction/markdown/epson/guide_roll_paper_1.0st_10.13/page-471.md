...
|          3. | Transmit GS ( E <Function 49> to the printer. | Specifying the paper layout to 'None (does not use paper layout).' |
|          4. | Transmit GS ( E <Function 2> to the printer.  | Executing software reset, and close user setting mode.             |
...
with Peeler: [Msw8-1] and [Msw8-2]

TM-L90 models without Peeler: [Msw8-2]
