...
| FF (in page mode) | EXECUTING COMMAND | Print and return to standard mode        | PRINT COMMANDS          |
...
| DLE DC4 (fn = 1)  | EXECUTING COMMAND | Generate pulse at real-time              | MISCELLANEOUS COMMANDS  |
| DLE DC4 (fn = 2)  | EXECUTING COMMAND | Turn off the power                       | MISCELLANEOUS COMMANDS  |
| DLE DC4 (fn = 8)  | EXECUTING COMMAND | Clear buffer                             | MISCELLANEOUS COMMANDS  |
