...
## GS ( N p L p H fn m &lt;Function 50&gt;

[Name] Turn shading mode on/off [Format] ASCII GS ( N pL pH fn m a Hex 1D 28 4E 03 00 32 m a Decimal 29 40 78 3 0 50 m a [Range] ( pL + pH × 256) = 3 ( pL =3, pH =0) fn = 50 m = 0, 1, 48, 49 TM-J2000/J2100 : a = 48 [Default] m = 0, a = 48 [Default] Turns the character shadow mode on or off.
