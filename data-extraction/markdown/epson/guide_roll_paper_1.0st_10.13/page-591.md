...
TM-T90 , TM-T20 , TM-T88IV , TM-T70 , TM-T88V , TM-L90 , TM-P60

```
Program Example1 (Print a symbol repeatedly) >PRINT #1, CHR$(&H1D);"(k";CHR$(13);CHR$(0);CHR$(48);CHR$(80);CHR$(48);"TEST PRINT"; ← Save data <Function080> >PRINT #1, CHR$(&H1D);"(k";CHR$(3);CHR$(0);CHR$(48);CHR$(81);CHR$(48); ← Print symbol <Function081> >PRINT #1, CHR$(&H1D);"(k";CHR$(3);CHR$(0);CHR$(48);CHR$(81);CHR$(48); ← Print symbol <Function081>
```
