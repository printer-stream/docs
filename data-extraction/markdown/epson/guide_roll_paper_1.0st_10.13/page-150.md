...
## GS ( N p L p H fn m &lt;Function 49&gt;

[Name] Select background color [Format] ASCII GS ( N pL pH fn m Hex 1D 28 4E 02 00 31 m Decimal 29 40 78 2 0 49 m [Range] ( pL + pH × 256) = 2 ( pL =2, pH =0) TM-J2000 (single-color printing model): m = 48, 49 TM-J2100 (two-color printing model): 48 ≤ m ≤ 51

[Default] m = 48 [Description] Selects background color by m as follows:
