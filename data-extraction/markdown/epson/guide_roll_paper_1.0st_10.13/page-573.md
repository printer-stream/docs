...
- ■ When JIS code system is selected, if Kanji mode is canceled, the printer processes a character code as a 1byte code of alphanumeric Katakana characters.
- ■ Kanji mode is canceled at default.

[Notes for  Simplified Chinese model]
