...
```
[Name] QR Code: Select the error correction level [Format] ASCII GS ( k pL pH cn fn n Hex 1D 28 6B 03 00 31 45 n Decimal 29 40 107 3 0 49 69 n [Range] ( pL + pH × 256) = 3 ( pL = 3, pH =0) cn = 49 fn = 69 48 ≤ n ≤ 51 [Default] n = 48 [Description] Selects the error correction level for QR Code.
```

|   n | Function                         |   Recovery Capacity %(approx.) |
|-----|----------------------------------|--------------------------------|
|  48 | Selects Error correction level L |                              7 |
|  49 | Selects Error correction levelM  |                             15 |
