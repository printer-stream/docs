...
|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| OFF        | When the printer recovers from the error, paper layout is measured automatically and paper is fed to the label print starting position and the paper layout stored in the non- volatile memory is rewritten. Afterwards, the printer operates following the paper layout automatically measured.                                                       |
