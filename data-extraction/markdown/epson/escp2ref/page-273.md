...
| Attributes                | ESC/P 2               | Previous ESC/P levels                       |
|---------------------------|-----------------------|---------------------------------------------|
| Character table           | ESC t, ESC (          | ESC t                                       |
| Point size (height)       | ESC X                 | ESC w                                       |
| Typeface                  | ESC k                 | ESC k                                       |
| Pitch (proportional/fixed | spacing) ESC X, ESC c | ESC P, M, g, p, W, ESC SP, SO, SI, DC2, DC4 |
| Style (italics/normal)    | ESC 4, ESC 5          | ESC 4, ESC 5                                |
| Weight (bold/normal)      | ESC E, ESC F          | ESC E, ESC F                                |

Each time you change one of the above attributes, the printer selects a new font. If a font matching the selected attributes is not available in the printer's ROM memory, the printer manufactures a temporary font with those attributes.
...
| Double-strike   | ESC G, ESCH    |
|-----------------|----------------|
| Score           | ESC ( -, ESC - |
| Shadow/outline  | ESC q          |
