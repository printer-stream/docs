...
- On 24/48-pin printers, you can use the ESC t 2 command to copy character data (including user-defined characters) from codes 0 to 127 to codes 128 to 255. This is desirable if you wish to print codes between 0 and 127 as usual while having access to user-defined characters.
