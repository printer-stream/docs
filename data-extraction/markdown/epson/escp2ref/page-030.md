...
```
1 ≤ n ≤ 255 0 ≤ (left margin) <(right margin) 80-column printers: 0 ≤ (left margin) ≤ 4.50 inches 110-column printers: 0 ≤ (left margin) ≤ 7.00 inches 136-column printers: 0 ≤ (left margin) ≤ 8.00 inches
```
...
- The following commands affect character pitch: ESC X, ESC c, ESC P, ESC M, ESC g, ESC W, ESC p, ESC SP, SO, ESC ! and SI.
