...
; Bar length value v1 and v2 are ignored. POSTNET uses the fixed bar length.
...
## Vavaldaadabaaldaataadalatealdsoleatballatillal
...
## VooaDdaababasTdosTusTadadabasbovsldostatadaadtal
