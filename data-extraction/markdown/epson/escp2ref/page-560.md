...
A program used to send commands and transfer data from the computer to the printer. Most application programs include drivers that support EPSON printers.
