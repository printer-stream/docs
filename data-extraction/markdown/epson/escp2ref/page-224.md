...
```
Class 3 ASCII <XFER> n d1 . . . dn Binary 001F xxxxB n d1 . . . dn
```

## Parameter range

```
#BC = Low nibble value F = 0 then #BC = number of raster image data, where 0 ≤ #BC ≤ 15 F = 1 then #BC = number of raster image data counter, where #BC = 1, 2 number of raster data = n1 or n1 + n2 × 256
```
