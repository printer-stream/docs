...
To eliminate potential command conflicts during raster graphics printing, EPSON provides a special graphics mode. In this mode, some commands are not available. See 'Graphics mode' for details.
...
ESC * m nL nH d1 d2 . . . d k m Specifies the dot density and printing speed. The dot

density can be specified from 60 × 60 dpi (dots per inch) to up to 360 × 360 dpi, depending on the number of pins in the print head. The printing speed depends on the printing of adjacent horizontal dots; by not allowing the printing of adjacent dots, you increase the printing speed.
