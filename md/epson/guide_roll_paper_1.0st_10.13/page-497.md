...
- When a page mode is selected, all the data printed collectively by FF or ESC FF is printed at the same speed. 

[Model-dependent variations] TM-J2000/J2100, TM-P60, TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-L90 
...
**See the** GS ( E **<Function 5: (** a **=6)> model information for details of the printing speed level.** 

## TM-L90 

TM-L90 **with Peeler** 

**When the peeling issuing mode is selected, select a print speed slower than level 6 (120mm/s).** 
