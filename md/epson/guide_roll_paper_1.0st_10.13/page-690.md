...
> (*3) The key code and terminator are not included in the data. If the stored data in the record is abnormal, it will be one-byte data of [Hexadecimal = FFH/Decimal = 255]. 
