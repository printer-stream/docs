...
|**Program Example for all printers**<br>PRINT #1, CHR$(&H1D);"!";CHR$(17);<br>PRINT #1, "AAAAA"; CHR$(&HA);<br>PRINT #1, CHR$(&H1D);"!";CHR$(0);<br>PRINT #1, "BBBBB"; CHR$(&HA);||**Print Sample**<br>AAAAA ← Select quadruple (double-height x double-width)<br>BBBBB|
|---|---|---|
