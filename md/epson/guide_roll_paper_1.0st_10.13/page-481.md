...
## **The offline cause of this printer is constructed of 5 bytes as shown in the following tables.** 
...
||**On**|**01**|**1**|**CPU execution error has occurred.**|
|**1**|**Off**|**00**|**0**|**ROM error hasn’t occurred in the memory.**|
||**On**|**02**|**2**|**ROM error has occurred in the memory.**|
|**2**|**Off**|**00**|**0**|**G/A error hasn’t occurred in the gate array.**|
||**On**|**04**|**4**|**G/A error has occurred in the gate array.**|
|**3 ~ 5**|**-**|**-**|**-**|**Reserved.**|
|**6**|**On**|**40**|**64**|**Fixed.**|
|**7**|**0**|**00**|**0**|**Fixed.**|
...
## **When one of the above errors occurs, turn off the printer immediately.** 
...
|**2**|**Off**|**00**|**0**|**Overcurrent error hasn’t occurred.**|
||**On**|**02**|**2**|**Overcurrent error has occurred.**|
