...
[Name] Select print position of HRI characters [Format] ASCII GS H n Hex 1D 48 n Decimal 29 72 n [Range] 0 ≤ n ≤ 3 48 ≤ n ≤ 51 

[Default] n = 0 

## [Printers not featuring this command] TM-U230, TM-U220 

- [Description] Selects the print position of Human Readable Interpretation (HRI) characters  when printing a bar code, using n as follows: 
