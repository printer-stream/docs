...
## **GS ( L** _**pL pH m fn x y**_ <Function 49> 

- [Name] Set the reference dot density for graphics. 

- [Format] 

ASCII GS ( L pL pH m fn x y Hex 1D 28 4C 04 00 30 fn x y Decimal 29 40 76 4 0 48 fn x y 
...
- [Description] Sets the reference dot density to process the graphics data or bit image data. (dpi: dots per inch) 
