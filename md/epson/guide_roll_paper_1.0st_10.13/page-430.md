...
[Name] Execute power-off sequence [Format] ASCII DLE DC4 fn a b Hex 10 14 02 a b Decimal 16 20 2 a b 
...
- [Notes] ■ This command can be used after enabling real time command processing with GS ( D. 
