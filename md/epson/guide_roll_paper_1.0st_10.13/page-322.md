...
[Format] ASCII GS Q 0 m xL xH yL yH d1...dk Hex 1D 51 30 m xL xH yL yH d1...dk Decimal 29 81 48 m xL xH yL yH d1...dk 

- [Printers not featuring this command] TM-T90, TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-L90, TM-P60, TM-U230, TM-U220 

[Range] 0 ≤ m ≤ 3, 48 ≤ m ≤ 51 

   - 1 ≤ (xL **+** xH × 256 _)_ ≤ 4256 (0 ≤ xL ≤ 255, 0 ≤ xH ≤ 12) 

   - 1 ≤ (yL **+** yH × 256 _)_ ≤ 16 (1 ≤ yL ≤ 16, yH = 0) 

   - 0 ≤ d ≤ 255 

   - k = (xL _**+**_ xH × 256) × (yL _**+**_ yH × 256) 

- [Description] Prints a variable vertical size bit image using the mode specified by m, as follows: 
