...
[Format] ASCII GS b n Hex 1D 62 n Decima 29 98 n [Range] 0 ≤ n ≤ 255 
...
- [Notes] ■ The smoothing mode is effective for quadruple-size or larger characters [alphanumeric, Kana, multilingual, and user-defined characters.] 
...
**Program Example for all printers** AAAAA PRINT #1, CHR$(&H1D);"!";CHR$(68); ← Select font size PRINT #1, CHR$(&H1D);"b";CHR$(1); ← Select smoothing PRINT #1, "AAAAA"; CHR$(&HA); 
