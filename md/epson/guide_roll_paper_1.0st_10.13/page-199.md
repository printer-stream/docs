...
[Format] ASCII GS \ nL nH Hex 1D 5C nL nH Decimal 29 92 nL nH [Range] –32768 ≤ (nL + nH × 256) ≤ 32767 

- [Default] None 

- [Printers not featuring this command] TM-U230, TM-U220 

- [Description] In page mode, moves the vertical print position to (nL + nH × 256) × (vertical or horizontal motion unit) from the current position. 
