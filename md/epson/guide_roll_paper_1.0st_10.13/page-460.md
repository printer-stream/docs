...
|---|---|---|---|---|
|Setting after<br>ESC @is executed|When the switch of the DM-D (customer display) connection is OFF.|1|-|1|
||When the switch of the DM-D (customer display) connection is ON.|1|-|2|
