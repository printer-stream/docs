...
- [Range] **(** pL **+** pH × 256 **) =** 2 **, (** pL **=** 2 **,** pH **=** 0 **),** fn **=** 2 **,** 50 TM-J2000/J2100 _,_ TM-T90, TM-L90 **,** TM-P60 **:** m **= 0,1, 48, 49** 

- [Description] Loads the command setting values stored in the storage area specified by m to the work area. 
