## **C O N F I D E N T I A L Program example for ESC i and ESC m** 

**Program Example** PRINT #1,"    AAAAA"; PRINT #1,CHR$(&H1B);"d";CHR$(5); PRINT #1,CHR$(&H1B);"m"; ← Cut paper PRINT #1,"    BBBBB"; PRINT #1,CHR$(&H1B);"d";CHR$(5); PRINT #1,CHR$(&H1B);"m"; ← Cut paper 

**==> picture [204 x 119] intentionally omitted <==**

**----- Start of picture text -----**<br>
Print Sample<br>AAAAA<br>ESC m leaves paper joined in three places.<br>B B B B B<br>ESC i leaves paper joined in one place.<br>**----- End of picture text -----**<br>
