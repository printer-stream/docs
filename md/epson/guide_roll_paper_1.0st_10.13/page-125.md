...
**Program Example for all printers Print Sample** PRINT #1, CHR$(&H1B);"G";CHR$(1); ← Select **AAAAA** ← Double-strike PRINT #1, "AAAAA"; CHR$(&HA); BBBBB ← Normal PRINT #1, CHR$(&H1B);"G";CHR$(0); ← Cancel PRINT #1, "BBBBB"; CHR$(&HA); 
