...
**This function cannot be used when the printer enters the “beginning of the line” or “data in print buffer” state during the standard mode.** 

**The dot density and maximum print area are the same as Function 69. See the model information of Function 69.** 

**Use the following settings for fastest processing time.** 

- ❏ **Not RS-232 serial interface communication.** 

- ❏ **Specify standard mode.** 

- ❏ **Specify left margin as 0, and the horizontal position to a position that is a multiple of 8. (Example: the left margin = 0, horizontal position = 0, 8, 16, or 24, etc.)** 
