...
|**Response code**|**Process**|
|---|---|
|ACK, CAN|End processingfor this command.|
|NAK|Resend previouslysent data.|
...
GOSUB *RECEIVE ← "Header to NUL" is received and stored under ST$ (details omitted) PRINT #1,CHR$(6); ← Response code is sent 
