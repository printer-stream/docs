...
|■The special characters ("(“,”)”) are processed as shown in the table below.|■The special characters ("(“,”)”) are processed as shown in the table below.|■The special characters ("(“,”)”) are processed as shown in the table below.|■The special characters ("(“,”)”) are processed as shown in the table below.|
|---|---|---|---|
|||||
|**Special characters**||||
|**Character**|**Hex**|**Decimal**|**Processing**|
|(|28|40|"(" is inserted for the HRI character. "(" does not constitute encoded<br>data.|
|)|29|41|")" is inserted for the HRI character. ")" does not constitute encoded<br>data.|
