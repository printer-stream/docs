...
|**Program Example for all printers**<br>PRINT #1, CHR$(&H1B);"r";CHR$(1);←Select red<br>PRINT #1, "AAAAA";CHR$(&HA);<br>PRINT #1, CHR$(&H1B);"r";CHR$(0);←Select black<br>PRINT #1,"BBBBB";CHR$(&HA);||**Print Sample**<br>AAAAA ←Red<br>BBBBB ←Black|
|---|---|---|
