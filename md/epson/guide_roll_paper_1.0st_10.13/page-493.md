## **C O N F I D E N T I A L GS ( K** <Function 49> 

[Name] Select the print density [Format] ASCII GS ( K pL pH fn m Hex 1D 28 4B 02 00 31 m Decimal 29 49 75 2 0 48 m [Range] (pL + pH × 256) = 2     (pL = 2, pH = 0) fn = 49 TM-T90 **: 250** ≤ m ≤ **255, 0** ≤ m ≤ **6** TM-L90 **: 250** ≤ m ≤ **255, 0** ≤ m ≤ **8** [Default] m = 0 

- [Description] Selects the print density by m. 

|m|**Function**|
|---|---|
|128 - 255|Pale density|
|0|Standard density [setting value ofGS ( EFunction 5<br>customize value (a= 5) ]|
