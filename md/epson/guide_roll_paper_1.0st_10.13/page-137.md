...
|[Name]|Select print color|Select print color|Select print color||
|---|---|---|---|---|
...
- [Printers not featuring this command] TM-T90, TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-L90, TM-P60 [Description] Selects a print color, using n as follows: 
