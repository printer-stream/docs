...
|---|---|---|---|
|ESC e|EXECUTING COMMAND|Print and reverse feednlines|PRINT COMMANDS|
...
|FS !|SETTING COMMAND|Select print mode(s) for Kanji characters|KANJICOMMANDS|
...
|FS W|SETTING COMMAND|Turn quadruple-size mode on/off for Kanji||
|||characters|KANJI COMMANDS|
