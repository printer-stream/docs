...
[Name] Set right-side character spacing [Format] ASCII ESC SP n Hex 1B 20 n Decimal 27 32 n [Range] 0 ≤ n ≤ 255 
...
- [Notes] ■ The character spacing set by this command is effective for alphanumeric, Kana, and user-defined characters. 
