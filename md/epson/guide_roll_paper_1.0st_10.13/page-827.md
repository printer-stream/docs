...
|---|---|
|**Paper layout (**sb**–**se**) is less than 24 mm {0.94 inch} or**<br>**Paper layout (**sb**–**se**) is more than or 29 mm  {1.1 inches}**|**Execute the paper feed to the manual cutter**<br>**position by “Cutting position” (**se**) specified by the**<br>**paper layout.**|
|**Paper layout (**b**–**e**) is between 24 mm {0.94 inch} and**<br>**29 mm  {1.1 inches}**|**Execute the paper feed by the amount which**<br>**corresponds to paper layout (**sb**–**se**).**|



***Set the paper layout (** sb **,** se **) by the Function 49 of** GS ( E **.** 
