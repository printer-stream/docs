...
## **GS ( L** _**pL pH m fn d1 d2 d3** <_ Function 65> 

[Name] Delete all NV graphics data. 

- [Format] 

   - ASCII GS ( L pL pH m fn d1 d2 d3 Hex 1D 28 4C 05 00 30 41 43 4C 52 Decimal 29 40 76 5 0 48 65 67 76 82 
...
- [Description] Deletes all NV graphics data that has been defined using Functions 67 or 68. 
