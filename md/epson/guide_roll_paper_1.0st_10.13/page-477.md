...
## **GS ( H** _**p**_ L _**p**_ H _**fn m d1 d2 d3 d4**_ <Function 48> 

[Format] ASCII GS ( H pL pH fn m d1 d2 d3 d4 Hex 1D 28 48 _06 00 30 30_ d1 d2 d3 d4 Decimal 29 40 72 _6 0 48 48_ d1 d2 d3 d4 [Range] (pL + pH × 256) = 6(pL = 6, pH = 0) fn = 48 m = 48 32 ≤ d1 ≤ 126 

32 ≤ d2 ≤ 126 32 ≤ d3 ≤ 126 32 ≤ d4 ≤ 126 

- [Description] Saves the specified process ID related to the processed data just before this function. 
