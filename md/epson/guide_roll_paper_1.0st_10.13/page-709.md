...
**This printer doesn’t support [Msw 1-6] (DM-D (Customer display) is connected or not)) and [Msw 2- 3] (Selecting character code system for the simplified Chinese model).** 
