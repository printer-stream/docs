...
## **GS ( C** _**pL pH m fn b c1 c2 d1...dk**_ <Function 1> 

- [Name] Store the data in the specified record 

[Format] ASCII GS ( C pL pH m fn b c1 c2 d1...dk Hex 1D 28 43 pL pH 00 fn 00 c1 c2 d1...dk Decimal 29 40 67 pL pH 0 fn 0 c1 c2 d1...dk [Range] 6 ≤ (pL + pH × 256) ≤ 65535 (0 ≤ pL ≤ 255, 0 ≤ pH ≤ 255) m = 0 
...
- [Description] Stores the data (d1... dk) as the record specified by the key codes (c1, c2) in the NV user memory. 
...
- [Model-dependent variations] TM-J2000/J2100, TM-T90, TM-T70, TM-L90, TM-P60, TM-U220 
