...
When standard mode is selected, prints data using Function 50 and clears the print buffer. When page mode is selected, prints data using FF and ESC FF and clears the print buffer after FF is executed. 
