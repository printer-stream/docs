...
[Name] Select font for HRI characters [Format] ASCII GS f n Hex 1D 66 n Decimal 29 102 n [Range] TM-J2000/J2100, TM-T90, TM-L90 **:** 

n **= 0, 1, 48, 49 (Other than Japanese model)** 

**0** ≤ n ≤ **2, 48** ≤ n ≤ **50 (Japanese model)** TM-T20 **: 0, 1, 48, 49** TM-T88IV, TM-T88V, TM-T70 **:** 

n **= 0, 1, 48, 49 (Other than South Asia model)** n **= 0, 1, 48, 49, 97, 98 (South Asia model)** TM-P60 **: 0** ≤ n ≤ **2, 48** ≤ n ≤ **50** 
