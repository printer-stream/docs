...
[Description] Stores the bit image data in the print buffer using the mode specified by bit image mode m as follows: 

|m|**Bit image Mode**|**Number of bits for**<br>**vertical data**|**Dot density in horizontal**|
|---|---|---|---|
