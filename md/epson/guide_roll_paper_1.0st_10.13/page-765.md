...
- It is recommended that the DIP switch be used to change communication condition. 

   - If the communication control between host and printer does not correspond, the printer cannot process data from the host normally, and the host cannot receive data from the printer normally. 
...
**DIP switch for setting communication condition is Sw 2. When DIP switch is off, this function is enabled. Turn off the printer before changing DIP switch settings. 7 baud rates are selectable.** 
