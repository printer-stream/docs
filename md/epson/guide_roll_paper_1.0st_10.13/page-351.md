...
|---|---|---|---|---|
|2|0|00|0|No recoverable error (except for autocutter<br>error).|
||1|04|4|Recoverable error occurred (except for<br>autocutter error).|
...
||1|40|64|Automatically recoverable error occurred.|
