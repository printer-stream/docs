...
|ESC d|Print and feednlines|PRINT COMMANDS|
|ESC e|Print and reverse feednlines|PRINT COMMANDS|
|ESC i<br>*****|Partial cut (one point left uncut)|MECHANISM CONTROL COMMANDS|
|ESC m<br>*****|Partial cut (three points left uncut)|MECHANISM CONTROL COMMANDS|
