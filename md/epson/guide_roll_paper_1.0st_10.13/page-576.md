...
- k **= 72 [Kanji Font A (24** × **24)** 

- k **= 32 [Kanji Font B (16** × **16)** 

TM-P60 **:** 

   - k **= 72 [Kanji Font A (24** × **24)** 

   - k **= 60 [Kanji Font B (20** × **24)** 

   - k **= 32 [Kanji Font C (16** × **16)** 

- TM-U230, TM-U220 **:** k **= 32** 
...
- [Notes] ■ This command is effective only for the Japanese, Simplified Chinese, Traditional Chinese, and Korean models. 

   - The printer processes k byte data of d1 _**...**_ dk as defined data. The defined data (d) sets a corresponding bit to 1 to print a dot or to 0 not to print a dot. 
