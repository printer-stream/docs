...
## **GS ( M** _**pL pH fn m**_ <Function 3> 
...
[Range] **(** pL **+** pH × 256 **) =** 2 **, (** pL **=** 2 **,** pH **=** 0 **),** fn **=** 3, 51 TM-J2000/J2100 _,_ TM-T90 **,** TM-L90 **,** TM-P60 **:** m **= 0,1, 48, 49** 

- [Default] m = 0 

- [Description] Selects the command setting values loaded to the work area after the printer performs the initialization process. 
