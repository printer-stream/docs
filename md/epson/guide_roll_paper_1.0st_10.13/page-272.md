...
## **GS ( L** _**pL pH m fn a kc1 kc2 b**_ xL xH yL yH _**[c d1...**_ dk _**]1...[c d1...**_ dk _**]b**_ <Function 83 > 

## **GS 8 L** _**p1 p2 p3 p4 m fn a kc1 kc2 b**_ xL xH yL yH _**[c d1...**_ dk _**]1...[c d1...**_ dk _**]b**_ 

- [Name] Define the downloaded graphics data (raster format). 
...
[When using GS 8 L: 12 ≤ (p1 + p2 × 256 + p3 × 65536 + p4 × 16777216) ≤ 4294967295] m = 48, fn = 83, a = 48, a = 52 (TM-T88V only) 
