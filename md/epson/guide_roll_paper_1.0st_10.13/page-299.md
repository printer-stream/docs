...
## **GS D** _**m fn a kc1 kc2 b c d1...dk**_ <Function 67> 
...
- [Description] Converts Windows BMP data to the specified tone and defines NV graphics data (raster format) that corresponds to the key codes (kc1, kc2). 
   ...
   - c **Color of data to define** 49 Color 1 
