...
|fn|**Function No.**|**Function No.**|**Function name**|
|---|---|---|---|
|48|**Function 48**|**Function 48**|Select Kanji character font|
...
- [Notes] ■ This command is specified function by function code (fn). Operation details are different depending on function. 
