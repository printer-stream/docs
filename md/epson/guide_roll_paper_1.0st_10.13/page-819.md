...
- (*1) [Information type] is the parameter of this function (n) expressed as a decimal, converted to text data and sent from high-order bytes first. 
...
Example:  When [Vertical layout (sb) is 15, the data is the 2 bytes “15” 

[Hexadecimal = 31H, 35H / Decimal = 49,53]. 
