...
## **GS ( L** _**pL pH m fn kc1 kc2 x y** <_ Function 85> 

- [Name] Print the specified download graphics data. 

[Format] ASCII GS ( L pL pH m fn kc1 kc2 x y Hex 1D 28 4C 06 00 30 55 kc1 kc2 x y Decimal 29 40 76 6 0 48 85 kc1 kc2 x y [Range] (pL + pH × 256) = 6 (pL = 6, pH = 0) m = 48 fn = 85 

   - 32 ≤ kc1 ≤ 126 

   - 32 ≤ kc2 ≤ 126 TM-J2000/J2100, TM-T20, TM-T88V **:** x **= 1, 2,** y **= 1, 2** 
...
- [Notes] ■ This function is used to print downloaded graphics data defined using Functions 83 and 84 of this command. 
