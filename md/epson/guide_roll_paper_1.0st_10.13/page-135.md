...
[Name] Turn 90 ° clockwise rotation mode on/off [Format] ASCII ESC V n Hex 1B 56 n Decimal 27 86 n [Range] 0 ≤ n ≤ 2, 48 ≤ n ≤ 50 [Default] n = 0 
...
- [Notes] ■ The 90 ° clockwise rotation mode is effective for alphanumeric, Kana, multilingual, and user-defined characters. 
   ...
   - The 90 ° clockwise rotation mode has no effect in page mode. If this command is processed in page mode, an internal flag is activated, and this flag is enabled when the printer returns to standard mode. 
