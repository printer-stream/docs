...
[Name] Send real-time request to printer [Format] ASCII DLE ENQ n Hex 10 05 n Decimal 16 5 n [Range] TM-J2000/J2100, TM-T90, TM-L90 **: 0** ≤ n ≤ **2** TM-T20, TM-T88IV, TM-T88V **:** n **= 1, 2** TM-T70 **: n = 1, 2 [Other than the following model] n = 2 [Japanese model]** TM-P60, TM-U220 **:** n **= 2** TM-U230 **:** n **= 0, 2** [Default] None 
...
|n|**Request**|
|---|---|
|0|Recovers to online status when following online recovery waiting status.<br>In the waiting status for the button to be pressed, the printer operates in the same way as when<br>the FEED button is pressed once.|
