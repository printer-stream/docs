...
**Program Example for all printers** PRINT #1, "          AAAAA"; CHR$(&HA); PRINT #1, CHR$(&H1D);"V";CHR$(66);CHR$(0); ← Feed paper and cut 

**Print Sample** AAAAA Paper fed to the cutting position and partial cut (one point left uncut) performed 
