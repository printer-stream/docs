...
[Name] Set print position to the beginning of print line [Format] ASCII GS T n Hex 1D 54 n Decimal 29 84 n [Range] n = 0, 1, 48, 49 [Default] None 

[Printers not featuring this command] TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-P60, TM-U230, TM-U220 

[Description] In standard mode, moves the print position to the beginning of the print line after performing the operation specified by n. 
