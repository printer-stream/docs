...
[Name] Start/end macro definition [Format] ASCII GS : Hex 1D 3A Decimal 29 58 [Range] None [Default] None 
...
- [Notes] ■ Macro definition starts when this command is processed during normal operation and ends when it is processed during macro definition. 
   ...
   - The following commands cannot be contained in a macro. Do not use these commands while the macro is being defined. 
      ...
      - GS ( A, GS ( C (part of functions), GS ( E (part of functions), GS ( L / GS 8 L (part of functions), GS ( M (part of functions), GS Q 0, GS ^, GS g 0, GS v 0, FS g 1, FS q. 
