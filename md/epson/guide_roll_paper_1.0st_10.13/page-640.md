## **C O N F I D E N T I A L GS ( k** <Function 371> 

- [Name] 2-dimensional GS1 DataBar: GS1 DataBar Expanded Stacked maximum width setting 

- [Format] 

   - ASCII GS ( k pL pH cn fn nL nH Hex 1D 28 6B 04 00 33 47 nL nH Decimal 29 40 107 4 0 51 71 nL nH 
...
## fn **= 71** 
   ...
   - TM-P60 **: 106** ≤ (nL + nH × **256)** ≤ **3952** , (nL + nH × **256) = 0 (0** ≤ nL ≤ **255, 0** ≤ nH ≤ **15)** TM-T20 **,** TM-T88V **: 106** ≤ (nL + nH × **256)** ≤ **3952,** (nL + nH × **256) = 0 (0** ≤ nL ≤ **255, 0** ≤ nH ≤ **15)** 

- [Default] TM-T20 **,** TM-P60 **:** (nL + nH × **256)** = **160 (** nL = **160,** nH = **0)** 

   - TM-T88V **:** (nL + nH × **256)** = **141 (** nL = **141,** nH = **0)** 

- [Description] Sets the maximum width of the module for GS1 DataBar Expanded Stacked (2-dimensional GS1 DataBar) to (nL + nH x 256) dots. 

      - When (nL + nH x 256) = 0, maximum width does not set. 

- [Notes] ■ Settings of this function affect the processing of Functions 381 and 382. 
