...
||**Dot density**|**Maximumprint area (dot)**||**Dot density**|**Maximum print**<br>**area (dot)**|
|||**When paper layout is not used**<br>**or top of black mark is selected**|**When the bottom**<br>**of label is selected**|||
|× 1|**203 dpi**|**256 to 576**|**224 to 560**|**203 dpi**|**738**|
|× 2|**203/2 dpi**|**128 to 288**|**112 to 280**|**203/2 dpi**|**369**|



**A horizontal maximum print area is determined according to the width of the paper.** 

||**Paper width**|**Double density (**m**= 0,2,48,50)**|**Single density (**m**= 1,3,49,51)**|
|---|---|---|---|
|**When paper**<br>**layout is not used**<br>**or top of black**<br>**mark is selected**|**80 to 78 mm**|**576 dot**|**288 dot**|
||**77 to 38 mm**|**(256 + (paper width – 38)**×**8) dot **|**(256 + (paper width – 38)**×**8 / 2) dot**|
|**When the bottom**<br>**of label is**<br>**selected**|**80 mm**|**560 dot**|**280 dot**|
||**79 to 38 mm**|**(224 + (paper width – 38)**×**8) dot **|**(224 + (paper width – 38)**×**8 / 2) dot**|
