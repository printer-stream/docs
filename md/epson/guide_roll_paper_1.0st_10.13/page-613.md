...
|**Cause**|**Solution**|
|---|---|
|There are data in the print buffer<br>in the standard mode|Put the printer in the state “there is no data in the<br>print buffer” by executingGS Tor print commands<br>(LF, CR, ESC J).|
|Symbol is bigger than the current<br>print area.|Expand the print area byGS W,ESC W,ESC $.<br>Reduce the module width by Function 067.<br>Reduce the module height by Function 068.<br>Lower the error correction level by Function 069.|
