## **C O N F I D E N T I A L GS ( k** <Function 472> 

[Name] Composite Symbology: Select font  HRI characters 

[Format] ASCII GS ( k pL pH cn fn n Hex 1D 28 6B 03 00 34 48 n Decimal 29 40 107 3 0 52 72 n [Range] (pL + pH × 256) = 3 (pL =3, pH =0) cn = 52 fn = 72 

TM-P60 **: 0** ≤ n ≤ **3, 48** ≤ n ≤ **51** TM-T20 **: 0** ≤ n ≤ **2, 48** ≤ n ≤ **50** TM-T88V **: 0** ≤ n ≤ **2, 48** ≤ n ≤ **50 (Other than the following model) 0** ≤ n ≤ **2, 48** ≤ n ≤ **50,** n **= 97, 98 (South Asia model)** 

- [Range] 

n = 0 

[Description] Selects a font for the Human Readable Interpretation (HRI) characters when printing Composite Symbology, using n as follows: 
