## **C O N F I D E N T I A L GS ( L** _**pL pH m fn** <_ Function 51 > 
...
- [Range] (pL + pH × 256) = 2 (pL = 2, pH = 0) m = 48 fn = 3, 51 

- [Description] Transmits the number of bytes of remaining memory (unused area) in the NV graphics area. 
