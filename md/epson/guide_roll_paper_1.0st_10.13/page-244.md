...
## **GS ( L** _**pL pH m fn d1 d2** <_ Function 64 > 

[Name] Transmit the key code list for defined NV graphics. 

[Format] ASCII GS ( L pL pH m fn d1 d2 Hex 1D 28 4C 04 00 30 40 4B 43 Decimal 29 40 76 4 0 48 64 75 67 [Range] (pL + pH × 256) = 4 (pL = 4, pH = 0) m = 48 
...
## (*1) When the number of NV graphics data groups exceeds 40, the groups are divided into blocks: 
