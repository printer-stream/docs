...
## **GS ( E** _**pL pH fn a**_ <Function 14> 

[Name] Transmit the configuration item for the Bluetooth interface 

[Format] ASCII GS ( E pL pH fn a Hex 1D 28 45 02 00 0E a Decimal 29 40 69 02 00 14 a [Range] (pL + pH × 256) = 2 (pL = 2, pH = 0) fn = 14 a = 48, 49, 65 

- [Description] Transmits the configuration item for the Bluetooth interface specified by a. 

|a|**Communication item**|
|---|---|
|48|Bluetooth device address<br>(BD_ADDR)|
|49|Passkey|
|50|Device name|
