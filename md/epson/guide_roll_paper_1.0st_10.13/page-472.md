...
[Name] Enable/disable real-time command [Format] ASCII GS ( D pL pH m [a1 b1]...[ak bk] Hex 1D 28 44 pL pH 14 [a1 b1]...[ak bk] Decimal 29 40 68 pL pH 20 [a1 b1]...[ak bk] 

- [Printers not featuring this command] TM-U230 

- [Range] (pL _**+**_ pH × 256) = 3, 5 (pL = 3, 5, pH = 0) m = 20 

## TM-J2000/J2100, TM-T90, TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-L90 **:** 

a **= 1, 2** 

b **= 0, 1, 48, 49** TM-P60 **:** a **= 2** b **= 0, 1, 48, 49** TM-U220: a **= 1** b **= 0, 1, 48, 49** 
...
[Description] Enables or disables the real-time command. 
