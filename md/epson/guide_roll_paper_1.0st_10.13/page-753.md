...
|Identifier<br>|27H|39|1 byte|
|Value number(*1)|31H−39H|48−57|1−3 bytes|
|Separation code<br>|1FH|31|1 byte|
|Setting(*2)|30H−39H|48−57|1−5 bytes|
|NUL|00H|0|1 byte|



- (*1) The decimal value for the customized value number (a; parameter of this function) is converted to ASCII 

- character data and sent starting from the high order end. 

## Example: 

If the a is 118, the “118” (expressed hexadecimally as 31H, 31H, 38H. Decimally as 49, 49, 56) is converted to 3- bytes data. 
