...
- [Name] Select counter mode (B) [Format] ASCII GS C ; sa ; sb ; sn ; sr ; sc  ; Hex 1D 43 3B sa 3B sb 3B sn 3B sr 3B sc 3B Decimal 29 67 59 sa 59 sb 59 sn 59 sr 59 sc 59 
...
[Description] Sets the serial number counter range, the serial number counter value, the stepping amount, and the repetition number by using character strings. 

|**Count mode **|**Parameters**|**Counter range**|**Counter range**|
|---|---|---|---|
|||**Minimum value **|**Maximum value**|
|Count-up|sa <sb,sn ≠“0”, andsr≠“0“|sa|sb|
|Count-down|sa>sb,sn ≠“0“, andsr ≠“0“|sb|sa|
|Count-stop|sa =sb,sn = “0“, orsr =“ 0“|⎯|⎯|
