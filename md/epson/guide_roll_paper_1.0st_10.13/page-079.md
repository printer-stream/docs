...
[Format] ASCII LF Hex 0A Decimal 10 [Range] None [Default] None 
...
**Program Example for all printers Print Sample** PRINT #1, "AAAAA"; CHR$(&HA); AAAAA PRINT #1, "BBBBB"; CHR$(&HA); BBBBB 
