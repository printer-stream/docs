...
|ESC i|EXECUTING COMMAND|Partial cut (one point left uncut)|MECHANISMCONTROLCOMMANDS|
|ESC m|EXECUTING COMMAND|Partial cut (three points left uncut)|MECHANISMCONTROLCOMMANDS|
