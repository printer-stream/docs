...
[Name] Print and reverse feed n lines [Format] ASCII ESC e n Hex 1B 65 n Decimal 27 101 n [Range] TM-U230, TM-U220 **: 0** ≤ n ≤ **2** [Default] None 
...
**Program Example for all printers Print Sample** PRINT #1, "AAAAA"; CHR$(&HA); AAAAACCCCC PRINT #1, "BBBBB"; CHR$(&H1B);"e";CHR$(1); BBBBB Paper reverse fed one line after printing the PRINT #1, "     CCCCC"; CHR$(&HA); line of Bs 
