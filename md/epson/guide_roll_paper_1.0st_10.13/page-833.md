...
## **FS ( L** _**pL pH fn sn**_ <Function 80> 

[Name] Paper layout error special margin setting 

[Format] ASCII FS ( L pL pH fn sn Hex 1C 28 4C pL pH _50_ sn Decimal 28 40 76 pL pH _80_ sn [Range] (pL + pH × 256) = 2,3 (pL = 2, 3, pH = 0) fn = 80 TM-P60 **: “0”** ≤ sn ≤ **“50”** 

- [Default] sn = “0” 

- [Description] 

Sets the paper layout error special margin. 
