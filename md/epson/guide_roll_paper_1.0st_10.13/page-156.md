...
[Name] Turn white/black reverse print mode on/off [Format] ASCII GS B n Hex 1D 42 n Decimal 29 66 n [Range] 0 ≤ n ≤ 255 
...
- ■ This command is effective until ESC @ is executed, the printer is reset, or the power is turned off. ■ In white/black reverse print mode, characters are printed in white on a black background. 
