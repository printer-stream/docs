...
PRINT #1, CHR$(&H1D);"(E";CHR$(3);CHR$(0);CHR$(1);CHR$(73);CHR$(78); ← <Function 1> GOSUB *RECEIVE ← Check "mode change notice" (Details omitted) PRINT #1, CHR$(&H1D);"(E";CHR$(10);CHR$(0);CHR$(3);CHR$(1); ← <Function 3> PRINT #1, CHR$(50);CHR$(50);CHR$(50);CHR$(50);CHR$(48);CHR$(49);CHR$(48);CHR$(49); PRINT #1, CHR$(&H1D);"(E";CHR$(2);CHR$(0);CHR$(4);CHR$(1); ← <Function 4> GOSUB *RECEIVE 4  ← Check the setting (Details omitted) 

PRINT #1, CHR$(&H1D);"(E";CHR$(7);CHR$(0);CHR$(5);CHR$(1);CHR$(2);CHR$(0);CHR$(2);CHR$(5);CHR$(0); ← <Function 5> PRINT #1, CHR$(&H1D);"(E";CHR$(2);CHR$(0);CHR$(6);CHR$(1); ← <Function 6> 

GOSUB *RECEIVE 6  ← Check the setting (Details omitted) 
