...
- Specify sa ~ sh are converted to character codes corresponding to decimal data, then transmitted from the MSB. (Example: When specifying 120, data is “120” (in decimal: 49, 50, 48; it is 3 byte).) 
