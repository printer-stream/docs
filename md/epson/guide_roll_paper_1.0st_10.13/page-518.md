...
- Printer information can be identified to other transmission data according to specific data of the 
   ...
   - transmission data block. When the header transmitted by the printer is [hex = 5FH/decimal =95], treat NUL [hex = 00H/decimal =0] as a data group and identify it according to the following data. 
...
**Bit 2: [DM-D (Customer display) is connected/not connected] indicates the state of Memory switch** 
