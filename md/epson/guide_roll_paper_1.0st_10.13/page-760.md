...
## **GS ( E** _**pL pH fn x c1 c2[y d1...d(x**_ × _**y)] k**_ <Function 9> 
...
ASCII GS ( E pL pH fn x c1 c2 [x d1...d(x × y)]k Hex 1D 28 45 pL pH 08 x c1 c2 [x d1...d(x × y)]k Decimal 29 40 69 pL pH 8 x c1 c2 [x d1...d(x × y)]k 5 ≤ (pL + pH × 256) ≤ 65535 (0 ≤ pL ≤ 255, 0 ≤ pH ≤ 255) fn = 9 128 ≤ c1 ≤ d2 ≤ 255 

0 ≤ d ≤ 255 

k = c2 – c1 + 1 

|fn= 9<br>128≤ c1 ≤ d2 ≤255<br>0≤ d ≤255<br>k=c2–c1+ 1|||
|---|---|---|
...
[Description] Defines the character pattern (raster format) for  the character code page in the work area. 
