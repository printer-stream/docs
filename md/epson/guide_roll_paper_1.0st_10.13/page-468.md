...
[Format] ASCII GS ( A pL pH n m Hex 1D 28 41 02 00 n m Decimal 29 40 65 2 0 n m 

- [Printers not featuring this command] TM-P60 

- [Range] (pL _+_ (pH × 256)) = 2   (pL _= 2,_ pH = 0) 

   - 0 ≤ n ≤ 2, 48 ≤ n ≤ 50 

TM-J2000/J2100, TM-T90, TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-U230,TM-U220 **: 1** ≤ m ≤ **3, 49** ≤ m ≤ **51** 

TM-L90 **: 1** ≤ **m** ≤ **3, 49** ≤ **m** ≤ **51,** m **= 64** 
