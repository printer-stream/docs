...
- **Bit 1 of the second byte is undefined.** 
...
- **Bit 0, and 1 of the second byte are undefined.** 

- **Basic third byte (paper sensor information)** 

- **The roll paper near-end sensor is an option. If the printer is not equipped with the paper near-end sensor, bits 0 and 1 of the third byte are always OFF, “Paper adequate.”** 
