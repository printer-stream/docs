...
- [Range] TM-J2000/J2100, TM-T90,TM-T20, TM-T88IV, TM-T88V, TM-T70, TM-L90, TM-P60 **: 0** ≤ n ≤ **2, 48** ≤ n ≤ **50** 

TM-U230, TM-U220 **:** n **= 0, 1, 48, 49** 

- [Default] 

   - n = 0 

- [Description] Turns on or off underline mode for multi-byte code character (Kanji-underline), using n as follows: 

|Turns on|or off underline mode for multi-byte code character (Kanji-underline), usingnas|
|---|---|
|n|**Function**|
...
- [Notes] ■ Settings of this command affect multilingual characters and user-defined characters. 
