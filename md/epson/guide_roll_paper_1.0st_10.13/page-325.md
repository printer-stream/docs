## **C O N F I D E N T I A L Program Example for GS Q 0** 

## **Program Example** 

PRINT #1, CHR$(&H1B);"U";CHR$(1); ← Specify unidirection PRINT #1, CHR$(&H1D);"p";CHR$(0); PRINT #1, CHR$(144);CHR$(0);CHR$(5);CHR$(0); FOR i=1 TO 144*5 

READ a$: d=VAL("&H"+a$) PRINT #1, CHR$(d); NEXT i 

PRINT #1, CHR$(&H1B);"U";CHR$(1); ← Select direction PRINT #1, CHR$(&H1C);"p";CHR$(0);CHR$(&HA); ← Normal PRINT #1, CHR$(&H1C);"p";CHR$(1);CHR$(&HA); ← Double width 
