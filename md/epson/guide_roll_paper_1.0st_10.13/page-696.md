...
- [Description] Controls the user setting modes. The table below explains the functions available in this command. 
...
|15|**Function 15**|Set conditions for USB interface communication|
|16|**Function 16**|Transmit conditions for USB interface communication|
