...
||||||**Paper layout is not used /**<br>**Top of a black mark**|**Bottom of a label**|
...
|---|---|---|
|**80 mm to 78 mm **|**288 dots**|**576 dots**|
|**77 mm to 38 mm **|**(256 + (paper width – 38)**×**8 / 2) dots**|**(256 + (paper width – 38)**× **8) dots**|
|**When paper layout is selected as the bottom of label.**|||
|**Paper width**|**Single density mode (**m**= 0, 32)**|**Double density mode (**m**= 1,33)**|
|**80 mm**|**280 dots**|**560 dots**|
|**79 mm to 38 mm **|**(224 + (paper width – 38)**×**8 / 2) dots**|**(224 + (paper width – 38)**×**8) dots**|
