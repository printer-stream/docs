...
## **GS ( C** _**pL pH m fn b**_ <Function 5> 

[Name] Transmit the key code list [Format] ASCII GS ( C 

- [Format] ASCII GS ( C pL pH m fn b Hex 1D 28 43 03 00 00 fn 00 Decimal 29 40 67 3 0 0 fn 0 
...
- [Notes] ■ When record exists, the printer sends the “Header to NUL” data as shown below: 

|**Send data**|**Hex**|**Decimal**|**Data quantity**|
|---|---|---|---|
|Header|37H|55|1 byte|
|Identifier<br>|71H|113|1 byte|
|Identification status(*1) (*2)<br>|40H or 41H|64 or 65|1 byte|
