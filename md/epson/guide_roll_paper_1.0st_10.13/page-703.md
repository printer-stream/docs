...
## **GS ( E** _**pL pH fn d1 d2**_ <Function 1> 

[Name] Change into the user setting mode 

- [Format] ASCII GS ( E pL pH fn d1 d2 Hex 1D 28 45 03 00 01 49 4E Decimal 29 40 69 3 0 1 73 78 

- [Range] (pL + pH × 256) = 3 (pL = 3, pH = 0) fn = 1 d1 = 73 d2 = 78 
...
|**Transmit data**|**Hex**|**Decimal**|**Dataquantity**|
|---|---|---|---|
