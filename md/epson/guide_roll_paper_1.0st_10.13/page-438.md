...
**You can confirm the battery remaining amount by looking at the “battery LED” (BAT).** 

**When memory switch [Msw 8-2] is On, this printer beeps when it enters the “L level“ or “S level.“ When the printer power is on:** 

|**rinter power is on:**|||
|---|---|---|
|**Battery**|**AC adapter**|**Battery LED (BAT.) status**|
|**Installed**|**Not installed**|**OFF: Battery remaining amount: H**<br>**level**|
|||**Blinking: Battery remaining amount:**<br>**M level**|
|||**ON: Battery remaining amount: L**<br>**level or S (*1)**|
||**Installed**|**Always Off**|
