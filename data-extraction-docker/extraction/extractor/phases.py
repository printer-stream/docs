...
Phase order: render -> text -> markdown -> [describe] -> quality -> assemble.
"""
...
# Phases that assemble folds into the pagemap lineage.
PRIOR_PHASES = ["render", "text", "markdown", "describe", "quality"]
